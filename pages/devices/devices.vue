	...
	<view class="container" :class="{ 'dark-theme': isDarkMode }">
		...
		<view class="header">
			<view class="location-tabs">
				<view v-for="(room, index) in rooms" :key="index" class="tab-item"
					:class="{ 'active': currentRoom === index }" @click="switchRoom(index)">
		...
		<scroll-view class="device-list" scroll-y>
			<view class="device-grid">
				<view v-for="device in currentRoomDevices" :key="device.id" class="device-card"
					:class="{ 'has-switch': device.hasSwitch }" @click="openDevice(device)">
					<!-- 设备图标 -->
					...
					<!-- 开关按钮 -->
					<view v-if="device.hasSwitch" class="device-switch" :class="{ 'on': device.isOn }"
